...
!function (t, e) {
    ...
    var i = function () {
        ...
        u = o('<ul class="dropdown-menu" role="list">', function (t, i) {
            var e = k.isArray(i.items) ? i.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "", o = i.template ? i.template(t) : t,
            ...
            var e = k.isArray(n.items) ? n.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "", o = n.template ? n.template(t) : t;
    ...
    var N = {
        head: w, last: x, initial: function (t) {
            return t.slice(0, t.length - 1)
        }, tail: S, prev: function (t, e) {
            var o = T(t, e);
    ...
    var L = /Edge\/\d+/.test(R), H = !!window.CodeMirror;
    ...
    var D = "ontouchstart" in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints,
        B = F || L ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input", z = {
            ...
            isFontInstalled: function (t) {
                var e = "Comic Sans MS" === t ? "Courier New" : "Comic Sans MS", o = k("<div>").css({
                        position: "absolute",
                        left: "-9999px",
                        top: "-9999px",
                        fontSize: "200px"
                    }).text("mmmmmmmmmwwwwwww").appendTo(document.body), n = o.css("fontFamily", e).width(),
    ...
    function wt(t, e) {
        ...
        var r = t.node.childNodes[t.offset], s = dt(t.node.cloneNode(!1), t.node);
    ...
    var Nt = {
        ...
        posFromPlaceholder: function (t) {
            var e = k(t), o = e.offset(), n = e.outerHeight(!0);
    ...
    function At(t) {
        var s = function (t, e) {
            var o, n;
            if (Nt.isText(t)) {
                var i = Nt.listPrev(t, C.not(Nt.isText)), r = N.last(i).previousSibling;
        ...
        }, e = document.body.createTextRange(), o = s(t.node, t.offset);
    ...
    var Rt = function () {
        ...
        return r.prototype.nativeRange = function () {
            ...
            o = o || C.ok;
            var n = t && t.includeAncestor, i = t && t.fullyContains, e = this.getStartPoint(), r = this.getEndPoint(),
                s = [], a = [];
            ...
            var e = Nt.ancestor(this.sc, t), o = Nt.ancestor(this.ec, t);
            ...
            var t = this.sc === this.ec, e = this.getPoints();
            ...
            var t = this.splitText(), e = t.nodes(null, {fullyContains: !0}),
            ...
            var e = k("<div></div>").html(t)[0], o = N.from(e.childNodes),
        ...
        create: function (t, e, o, n) {
            ...
            if (z.isW3CRangeSupport) {
                ...
                var s = document.selection.createRange(), a = s.duplicate();
                a.collapse(!1);
                var l = s;
                l.collapse(!0);
                var c = Et(l, !0), d = Et(a, !1);
            ...
            var e = t, o = 0, n = t, i = Nt.nodeLength(n);
            ...
            var o = Nt.fromOffsetPath(t, e.s.path), n = e.s.offset, i = Nt.fromOffsetPath(t, e.e.path), r = e.e.offset;
            return new Rt(o, n, i, r)
        }, createFromParaBookmark: function (t, e) {
            var o = t.s.offset, n = t.e.offset, i = Nt.fromOffsetPath(N.head(e), t.s.path),
                r = Nt.fromOffsetPath(N.last(e), t.e.path);
            return new Rt(i, o, r, n)
        }
    };
    k.summernote = k.summernote || {lang: {}}, k.extend(k.summernote.lang, {
        "en-US": {
            font: {
                bold: "Bold",
                italic: "Italic",
    ...
    var Pt = {
        ...
        }, nameFromCode: C.invertObject(Pt), code: Pt
    };
    var Ht = function () {
        function t(t) {
        ...
        return t.prototype.makeSnapshot = function () {
            ...
            return {
                ...
                bookmark: t ? t.bookmark(this.editable) : {s: {path: [], offset: 0}, e: {path: [], offset: 0}}
            }
        ...
        return t.prototype.jQueryCSS = function (o, t) {
            ...
            var r = Nt.makePredByNodeName(o), s = t.nodes(Nt.isText, {fullyContains: !0}).map(function (t) {
            ...
            if (n) {
                ...
                return s.map(function (t) {
                    var e = Nt.withClosestSiblings(t, r), o = N.head(e), n = N.tail(e);
            ...
            var e = k(Nt.isElement(t.sc) ? t.sc : t.sc.parentNode), o = this.fromNode(e);
            try {
                o = k.extend(o, {
        ...
        return t.prototype.insertOrderedList = function (t) {
            ...
            var i = this, e = Ft.create(t).wrapBodyInlineWithPara(), o = e.nodes(Nt.isPara, {includeAncestor: !0}),
            ...
            var n = this, e = Ft.create(t).wrapBodyInlineWithPara(), o = e.nodes(Nt.isPara, {includeAncestor: !0}),
            ...
            var n = this, e = Ft.create(t).wrapBodyInlineWithPara(), i = e.nodes(Nt.isPara, {includeAncestor: !0}),
                r = e.paraBookmark(i), s = N.clusterBy(i, C.peq2("parentNode"));
            ...
            var o = N.head(t), n = N.last(t), i = Nt.isList(o.previousSibling) && o.previousSibling,
                r = Nt.isList(n.nextSibling) && n.nextSibling, s = i || Nt.insertAfter(Nt.create(e || "UL"), n);
            ...
            var d = this, u = [];
            return k.each(t, function (t, e) {
                var o = N.head(e), n = N.last(e), i = c ? Nt.lastAncestor(o, Nt.isList) : o.parentNode,
                    r = i.parentNode;
        ...
        function r(t, e) {
            var o = b(t.rowIndex, e.cellIndex), n = 1 < e.colSpan, i = 1 < e.rowSpan,
        ...
        this.getActionList = function () {
            ...
            for (var t = i.rows, e = 0; e < t.length; e++) for (var o = t[e].cells, n = 0; n < o.length; n++) r(t[e], o[n])
        }()
    };
    Mt.where = {Row: 0, Column: 1}, Mt.requestAction = {Add: 0, Delete: 1}, Mt.resultAction = {
        Ignore: 0,
        SubtractSpanCount: 1,
        RemoveCell: 2,
        AddCell: 3,
    ...
    var Ot, Ut = function () {
        ...
        return t.prototype.tab = function (t, e) {
            var o = Nt.ancestor(t.commonAncestor(), Nt.isCell), n = Nt.ancestor(o, Nt.isTable),
                i = Nt.listDescendant(n, Nt.isCell), r = N[e ? "prev" : "next"](i, o);
            ...
            for (var o = Nt.ancestor(t.commonAncestor(), Nt.isCell), n = k(o).closest("tr"), i = this.recoverAttributes(n), r = k("<tr" + i + "></tr>"), s = new Mt(o, Mt.where.Row, Mt.requestAction.Add, k(n).closest("table")[0]).getActionList(), a = 0; a < s.length; a++) {
                var l = s[a], c = this.recoverAttributes(l.baseCell);
                switch (l.action) {
            ...
            var o = Nt.ancestor(t.commonAncestor(), Nt.isCell), n = k(o).closest("tr");
            k(n).siblings().push(n);
            for (var i = new Mt(o, Mt.where.Column, Mt.requestAction.Add, k(n).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) {
                var s = i[r], a = this.recoverAttributes(s.baseCell);
                switch (s.action) {
                    case Mt.resultAction.AddCell:
            ...
            for (var e = Nt.ancestor(t.commonAncestor(), Nt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = o[0].rowIndex, r = new Mt(e, Mt.where.Row, Mt.requestAction.Delete, k(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) if (r[s]) {
                var a = r[s].baseCell, l = r[s].virtualTable, c = a.rowSpan && 1 < a.rowSpan,
            ...
            for (var e = Nt.ancestor(t.commonAncestor(), Nt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = new Mt(e, Mt.where.Column, Mt.requestAction.Delete, k(o).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) if (i[r]) switch (i[r].action) {
                case Mt.resultAction.Ignore:
                    continue;
                case Mt.resultAction.SubtractSpanCount:
                    var s = i[r].baseCell;
        ...
        function t(t) {
            ...
            this.insertParagraph = this.wrapCommand(function () {
                ...
                var o = t.url, e = t.text, n = t.isNewWindow, i = t.range || u.createRange(),
        ...
        return t.prototype.initialize = function () {
            ...
            var e = this.options.keyMap[z.isMac ? "mac" : "pc"], o = [];
            ...
            var t = this.createRange().expand(Nt.isAnchor), e = k(N.head(t.nodes(Nt.isAnchor))),
        ...
        return t.prototype.initialize = function () {
            ...
            var i = this, n = k(), r = this.$dropzone.find(".note-dropzone-message");
            this.documentEventHandlers.onDragenter = function (t) {
                var e = i.context.invoke("codeview.isActivated"), o = 0 < i.$editor.width() && 0 < i.$editor.height();
    ...
    var Vt = function () {
        ...
        return t.prototype.sync = function () {
            ...
            var e = Nt.value(this.$codable, this.options.prettifyHtml) || Nt.emptyPara, o = this.$editable.html() !== e;
        ...
        return t.prototype.initialize = function () {
            ...
            this.options.airMode || this.options.disableResizeEditor ? this.destroy() : this.$statusbar.on("mousedown", function (t) {
                ...
                var o = n.$editable.offset().top - n.$document.scrollTop(), e = function (t) {
        ...
        return t.prototype.initialize = function () {
            ...
            this.$handle = k(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', this.options.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', this.options.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(this.$editingArea), this.$handle.on("mousedown", function (t) {
                if (Nt.isControlSizing(t.target)) {
                    t.preventDefault(), t.stopPropagation();
                    var e = r.$handle.find(".note-control-selection").data("target"), o = e.offset(),
                        n = r.$document.scrollTop(), i = function (t) {
            ...
            var e = Nt.isImg(t), o = this.$handle.find(".note-control-selection");
            if (this.context.invoke("imagePopover.update", t), e) {
                var n = k(t), i = n.position(), r = {
    ...
    }(), Zt = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i, Yt = function () {
        function t(t) {
            var o = this;
        ...
        return t.prototype.initialize = function () {
            ...
            if (this.lastWordRange) {
                var t = this.lastWordRange.toString(), e = t.match(Zt);
                if (e && (e[1] || e[2])) {
                    var o = e[1] ? t : "http://" + t, n = k("<a />").html(t).attr("href", o)[0];
        ...
        return t.prototype.representShortcut = function (t) {
            ...
            return this.ui.buttonGroup({
                ...
                children: [this.button({
                    ...
                    click: function (t) {
                        ...
                        }) : o ? p.context.invoke("editor.color", {backColor: e.attr("data-backColor")}) : n && p.context.invoke("editor.color", {foreColor: e.attr("data-foreColor")})
                    },
                    callback: function (t) {
                    ...
                    click: function (t) {
                        t.stopPropagation();
                        var e = k("." + h), o = k(t.target), n = o.data("event"), i = o.attr("data-value");
                        if ("openPalette" === n) {
                            var r = e.find("#" + i), s = k(e.find("#" + r.data("event")).find(".note-color-row")[0]),
                                a = s.find(".note-color-btn").last().detach(), l = r.val();
            ...
            this.context.memo("button.justifyLeft", C.invoke(r, "render")), this.context.memo("button.justifyCenter", C.invoke(s, "render")), this.context.memo("button.justifyRight", C.invoke(a, "render")), this.context.memo("button.justifyFull", C.invoke(l, "render")), this.context.memo("button.outdent", C.invoke(c, "render")), this.context.memo("button.indent", C.invoke(d, "render")), this.context.memo("button.paragraph", function () {
                return n.ui.buttonGroup([n.button({
                    ...
                    children: [r, s, a, l]
                }), n.ui.buttonGroup({className: "note-list", children: [c, d]})])]).render()
            ...
            var n = this, e = t || this.$toolbar, o = this.context.invoke("editor.currentStyle");
            ...
            var e, o = k(t.target.parentNode), n = o.next(), i = o.find(".note-dimension-picker-mousecatcher"),
                r = o.find(".note-dimension-picker-highlighted"), s = o.find(".note-dimension-picker-unhighlighted");
            if (void 0 === t.offsetX) {
                var a = k(t.target).offset();
                e = {x: t.pageX - a.left, y: t.pageY - a.top}
            } else e = {x: t.offsetX, y: t.offsetY};
            var l = Math.ceil(e.x / 18) || 1, c = Math.ceil(e.y / 18) || 1;
            r.css({
                width: l + "em",
                height: c + "em"
            }), i.data("value", l + "x" + c), 3 < l && l < this.options.insertTableMaxSize.col && s.css({width: l + 1 + "em"}), 3 < c && c < this.options.insertTableMaxSize.row && s.css({height: c + 1 + "em"}), n.html(l + " x " + c)
        }, t
    }(), te = function () {
        function t(t) {
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            var t = this.$toolbar.parent(".note-toolbar-wrapper"), e = this.$editor.outerHeight(),
                o = this.$editor.width(), n = this.$toolbar.height();
            t.css({height: n});
            var i = 0;
            this.options.otherStaticBar && (i = k(this.options.otherStaticBar).outerHeight());
            var r = this.$document.scrollTop(), s = this.$editor.offset().top;
        ...
        return t.prototype.initialize = function () {
            ...
            var e = this, t = this.context.invoke("editor.getLinkInfo");
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            if (this.context.invoke("editor.hasFocus")) {
                ...
                if (t.isCollapsed() && t.isOnAnchor()) {
                    var e = Nt.ancestor(t.sc, Nt.isAnchor), o = k(e).attr("href");
        ...
        return t.prototype.initialize = function () {
            var t = this.options.dialogsInBody ? this.$body : this.$editor, e = "";
            ...
            return k.Deferred(function (e) {
                var t = i.$dialog.find(".note-image-input"), o = i.$dialog.find(".note-image-url"),
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            if (Nt.isImg(t)) {
                var e = Nt.posFromPlaceholder(t), o = Nt.posFromPlaceholder(this.editable);
                this.$popover.css({
                    display: "block",
        ...
        return t.prototype.initialize = function () {
            ...
            var e,
                ...
                a = t.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/), l = t.match(/\/\/v\.qq\.com.*?vid=(.+)/),
                c = t.match(/\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.html\??.*/), d = t.match(/^.+.(mp4|m4v)$/),
                u = t.match(/^.+.(ogg|ogv)$/), h = t.match(/^.+.(webm)$/);
            if (o && 11 === o[1].length) {
                var p = o[1], f = 0;
                if (void 0 !== o[2]) {
                    var m = o[2].match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/);
                    if (m) for (var g = [3600, 60, 1], v = 0, b = g.length; v < b; v++) f += void 0 !== m[v + 1] ? g[v] * parseInt(m[v + 1], 10) : 0
                }
            ...
            var o = this, t = this.context.invoke("editor.getSelectedText");
            ...
            var i = this;
            return k.Deferred(function (e) {
                var o = i.$dialog.find(".note-video-url"), t = i.$dialog.find(".note-video-btn");
                i.ui.onDialogShown(i.$dialog, function () {
        ...
        return t.prototype.initialize = function () {
            ...
            var n = this, i = this.options.keyMap[z.isMac ? "mac" : "pc"];
            return Object.keys(i).map(function (t) {
                var e = i[t], o = k('<div><div class="help-list-item"/></div>');
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            var o = this, n = k('<div class="note-hint-group note-hint-group-' + e + '"/>');
            ...
            if (!N.contains([Lt.code.ENTER, Lt.code.UP, Lt.code.DOWN], t.keyCode)) {
                var e = this.context.invoke("editor.createRange").getWordRange(), n = e.toString();
        ...
        return t.prototype.initialize = function () {
            ...
            var e = this, o = k.extend({}, this.options.buttons);
            Object.keys(o).forEach(function (t) {
                e.memo("button." + t, o[t])
            });
            ...
            var t = N.head(arguments), e = N.tail(N.from(arguments)),
            ...
            var t = N.head(arguments), e = N.tail(N.from(arguments)), o = t.split("."), n = 1 < o.length,
                i = n && N.head(o), r = n ? N.last(o) : N.head(o), s = this.modules[i || "editor"];
            return !i && this[r] ? this[r].apply(this, e) : s && s[r] && s.shouldInitialize() ? s[r].apply(s, e) : void 0
        }, t
    }();
    k.fn.extend({
        summernote: function () {
            var t = k.type(N.head(arguments)), e = "string" === t, o = "object" === t,
        ...
        version: "0.8.11", ui: b, dom: Nt, range: Ft, plugins: {}, options: {
            modules: {
                editor: jt,
                clipboard: qt,
                dropzone: Kt,
            ...
            followingToolbar: !0,
            otherStaticBar: "",
            toolbar: [["style", ["style"]], ["font", ["bold", "underline", "clear"]], ["fontname", ["fontname"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph"]], ['fontsize', ['fontsize']], ["table", ["table"]], ["insert", ["link", "picture", "video"]], ["view", ["fullscreen", "codeview", "help"]]],
            popatmouse: !0,
            popover: {
