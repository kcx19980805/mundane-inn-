...
;!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        v: "3.1.1", ie: function () {
            ...
            return e = e || {}, r.cache = o.config = i.extend({}, o.config, e), r.path = o.config.path || r.path, "string" == typeof e.extend && (e.extend = [e.extend]), o.config.path && r.ready(), e.extend ? (a ? layui.addcss("sys/layer/" + e.extend) : o.link("theme/" + e.extend), this) : this
        }, ready: function (e) {
            var t = "layer", i = "", n = (a ? "sys/layer/" : "theme/") + "default/layer.css?v=" + r.v + i;
    ...
    r.prompt = function (e, t) {
        ...
        return delete e.success, r.open(i.extend({
            ...
            yes: function (i) {
                var n = s.val();
                //"" === n ? s.focus() :
                    n.length > (e.maxlength || 500) ? r.tips("&#x6700;&#x591A;&#x8F93;&#x5165;" + (e.maxlength || 500) + "&#x4E2A;&#x5B57;&#x6570;", s, {tips: 1}) : t && t(n, i, s)
            }
        }, e))
    }, r.tab = function (e) {
        e = e || {};
