	...
	function (_$$BootstrapTable) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function onPageListChange() {
	      ...
	      UtilsCookie.setCookie(this, UtilsCookie.cookieIds.pageList, this.options.limit);
	      UtilsCookie.setCookie(this, UtilsCookie.cookieIds.pageNumber, this.options.pageNumber);
	    }
	  }, {
	    key: "onPagePre",
	    ...
	    value: function initCookie() {
	      ...
	      this.options.pageNumber = pageNumberCookie ? +pageNumberCookie : this.options.pageNumber; // limit

	      this.options.limit = pageListCookie ? pageListCookie === this.options.formatAllRows() ? pageListCookie : +pageListCookie : this.options.limit; // searchText
