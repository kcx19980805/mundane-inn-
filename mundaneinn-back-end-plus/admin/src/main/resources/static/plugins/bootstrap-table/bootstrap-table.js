	...
	*/
	...
	if (isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
	  ...
	  for (var keys$1 = descriptors ? getOwnPropertyNames(NativeNumber) : (
	    ...
	    // ES2015 (in case, if sys with ES2015 Number statics required before):
	...
	function () {
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initPagination() {
	      ...
	      if (o.totalRows) {
	        if (o.limit === o.formatAllRows()) {
	          o.limit = o.totalRows;
	          $allSelected = true;
	        } else if (o.limit === o.totalRows) {
	        ...
	        this.totalPages = ~~((o.totalRows - 1) / o.limit) + 1;
	      ...
	      this.pageFrom = (o.pageNumber - 1) * o.limit + 1;
	      this.pageTo = o.pageNumber * o.limit;
	        ...
	        pageList.forEach(function (page, i) {
	          if (!o.smartDisplay || i === 0 || pageList[i - 1] < o.totalRows) {
	            ...
	            if ($allSelected) {
	              ...
	              active = page === o.limit ? _this6.constants.classes.dropdownActive : '';
	            }
	    ...
	    value: function updatePagination(event) {
	      ...
	      this.trigger('page-change', this.options.pageNumber, this.options.limit);
	    }
	  }, {
	    ...
	    value: function onPageListChange(event) {
	      ...
	      this.options.limit = $this.text().toUpperCase() === this.options.formatAllRows().toUpperCase() ? this.options.formatAllRows() : +$this.text();
	      this.$toolbar.find('.page-size').text(this.options.limit);
	    ...
	    value: function initServer(silent, query, url) {
	      ...
	      if (this.options.pagination && this.options.sidePagination === 'server') {
	        params.limit = this.options.limit === this.options.formatAllRows() ? this.options.totalRows : this.options.limit;
	      ...
	      if (this.options.queryParamsType === 'limit') {
	        ...
	        if (this.options.pagination && this.options.sidePagination === 'server') {
	          params.offset = this.options.limit === this.options.formatAllRows() ? 0 : this.options.limit * (this.options.pageNumber - 1);
	          params.limit = this.options.limit === this.options.formatAllRows() ? this.options.totalRows : this.options.limit;
