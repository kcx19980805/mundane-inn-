(function (global, factory) {
	...
	*/
	...
	BootstrapTable.prototype.calculatePipelineSize = function (pipelineSize, limit) {
	  /* calculate pipeline size by rounding up to the nearest value evenly divisible
	        * by the limit */
	  if (limit === 0) return 0;
	  return Math.ceil(pipelineSize / limit) * limit;
	};
	...
	BootstrapTable.prototype.initServer = function (silent, query, url) {
	  ...
	  if (this.options.queryParamsType === 'limit') {
	    ...
	    if (this.options.pagination && this.options.sidePagination === 'server') {
	      params.limit = this.options.limit === this.options.formatAllRows() ? this.options.totalRows : this.options.limit;
	      params.offset = (this.options.limit === this.options.formatAllRows() ? this.options.totalRows : this.options.limit) * (this.options.pageNumber - 1);
