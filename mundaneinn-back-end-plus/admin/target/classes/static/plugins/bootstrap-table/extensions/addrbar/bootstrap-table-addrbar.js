	  ...
	  _createClass(_class, [{
	    ...
	    value: function init() {
	      ...
	      if (this.options.pagination && this.options.sidePagination === 'server' && this.options.addrbar) {
	        ...
	        this.options.limit = +_GET("".concat(_prefix, "size")) || $.BootstrapTable.DEFAULTS.limit;
	        ...
	        this.options.onLoadSuccess = function (data) {
	          if (_this.addrbarInit) {
	            ...
	            var params = {};
	            params["".concat(_prefix, "page")] = _this.options.pageNumber, params["".concat(_prefix, "size")] = _this.options.limit, params["".concat(_prefix, "order")] = _this.options.sortOrder, params["".concat(_prefix, "sort")] = _this.options.sortName, params["".concat(_prefix, "search")] = _this.options.searchText; // h5提供的修改浏览器地址栏的方法
